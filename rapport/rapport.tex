...
L'exploration de l'arbre d'un semi-groupe numérique n'est pas triviale et est apparentée au problème de Frobenius.
...
Ce montant est nommé ``nombre de Frobenius'' et est plus formellement décrit par le plus grand entier qu'il est impossible à calculer à partir de montants donnés.
