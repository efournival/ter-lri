...
\begin{itemize}
	...
	\item	attention à une possible régression de Go lors du passage en version 1.8 : les mesures de temps des appels au code original de \texttt{NumericMonoid} semblent différer alors qu'elles étaient identiques avant
\end{itemize}
